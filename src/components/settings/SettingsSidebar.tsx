...
export default function SettingsSidebar({ activeSection, onSectionChange }: SettingsSidebarProps) {
  return (
    <div className="w-[260px] h-full bg-bg-sidebar border-r border-border-subtle flex flex-col">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 h-10 rounded-lg text-sm transition-colors ${
              activeSection === section.id
                ? "bg-bg-active [&>svg]:text-accent-primary text-text-primary font-medium"

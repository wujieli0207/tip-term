...
export const DEFAULT_HOTKEYS: Omit<HotkeyDefinition, "currentBinding">[] = [
  ...
  {
    id: "terminalSearchNext",
    action: "terminalSearchNext",
    label: "Find Next",
    description: "Find next match in terminal search",
    scope: "terminal",
    defaultBinding: binding("enter"),
    category: "Terminal",
  },
  {
    id: "terminalSearchPrev",
    action: "terminalSearchPrev",
    label: "Find Previous",
    description: "Find previous match in terminal search",
    scope: "terminal",
    defaultBinding: binding("enter", "shift"),
    category: "Terminal",
  },
  {
    id: "terminalSearchToggleCase",
    action: "terminalSearchToggleCase",
    label: "Toggle Match Case",
    description: "Toggle case-sensitive search",
    scope: "terminal",
    defaultBinding: binding("c", "alt"),
    category: "Terminal",
  },
  {
    id: "terminalSearchToggleRegex",
    action: "terminalSearchToggleRegex",
    label: "Toggle Regex",
    description: "Toggle regular expression search",
    scope: "terminal",
    defaultBinding: binding("r", "alt"),
    category: "Terminal",
  },
  {
    id: "terminalSearchToggleWholeWord",
    action: "terminalSearchToggleWholeWord",
    label: "Toggle Whole Word",
    description: "Toggle whole-word matching",
    scope: "terminal",
    defaultBinding: binding("w", "alt"),
    category: "Terminal",
  },
